...
//        mIsCanLoop = typedArray.getBoolean(R.styleable.MZBannerView_canLoop,false);//开启则是无限循环
    ...
    private void setOpenMZEffect(){
        ...
        if(mIsOpenMZEffect){
            if(mIsMiddlePageCover){
                ...
                mViewPager.setPageTransformer(true,new CoverModeTransformer(mViewPager,getContext()));
            }else{
                // 中间页面不覆盖，页面并排，只是Y轴缩小
    ...
    public  void viewpageMove(boolean isLeft){
...
//        TODO 强制写死
           ...
           view.setOnClickListener(new OnClickListener() {
            ...
            view.setOnFocusChangeListener(new OnFocusChangeListener() {
                ...
                public void onFocusChange(View v, boolean hasFocus) {
                    if(mPageClickListener!=null){
                        mPageClickListener. onPageFocus(v,hasFocus);
                    }
    ...
    public interface BannerPageClickListener{
        ...
        void onPageFocus(View view,boolean hasfocus);
    }
